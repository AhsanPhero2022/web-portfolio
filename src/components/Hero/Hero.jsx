...
import profileImg from "../../assets/abir.png";
...
const Hero = () => {
  return (
    <div
      style={{
        backgroundImage:
          "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACgAAAAoBAMAAAB+0KVeAAAAAXNSR0IB2cksfwAAAAlwSFlzAAALEwAACxMBAJqcGAAAABVQTFRFnJybwsLB5ublu7u7m5ubAAAA5ublHkCv9wAAAAd0Uk5TCQgJBgcACA9AjvwAAAAhSURBVHicY2BUwgCKDCahGCCEIRVTMHRUcFRwxAliyx0A6BQHnn3kz9cAAAAASUVORK5CYII=)",
      }}
    >
      <div className="h-[calc(100vh-80px)] max-w-7xl px-4 md:px-10 mx-auto flex flex-col-reverse md:flex-row justify-center md:justify-between items-center">
        <div
          className="w-full md:w-3/5 py-3 overflow-hidden md:overflow-visible"
          data-aos="fade-up"
          data-aos-offset="200"
        ...
        >
          ...
          <TypeAnimation
            ...
            repeat={Infinity}
          />
          <p className="roboto-font mt-4 mb-6 w-full md:w-5/6 text-gray-400">
            Welcome to my captivating portfolio website! I am a passionate
            front-end web application developer with expertise in building
          ...
          <div>
            <ScrollLink to="projects" smooth={true} duration={500} offset={-80}>
              <button
                ...
                data-aos-duration="2000"
                data-aos-offset="50"
                className="px-7 py-3 mr-5 relative inline-flex items-center justify-center font-medium text-white bg-gray-800 rounded-lg group bg-gradient-to-br from-[#3669ac] to-[#35aac7] group"
              >
            ...
            <ScrollLink to="contact" smooth={true} duration={500} offset={-80}>
              ...
              >
                ...
                <span className="absolute flex items-center justify-center w-full h-full text-[#35aac7] transition-all duration-300 transform group-hover:translate-x-full ease">
                  Hire Me
                </span>
